		...
		<tbody>
			...
			<?php foreach($proforma as $row): ?>
				...
				<tr <?php if($row[6] == 0){echo "class='proformared'"; } else { echo "class='proformablack'"; } ?>>
					...
					<?="<td> <a href='administrator/proforma/showproforma/$row[4]/$row[0]'>$row[4]</a><a href='administrator/proforma/showproforma/$row[4]/$row[0]'> <span class='oi oi-file' title='file' aria-hidden='true'></span></a> " ?></td>
