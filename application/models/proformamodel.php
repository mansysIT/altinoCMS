...
class proformamodel
{
    ...
    public function sendproforma(){
        ...
        $this->proformy_mail_wyslij($email, $this->__params[2], $betaald, TRUE);
    ...
    public function createproforma($create, $ilemaili = null) {
